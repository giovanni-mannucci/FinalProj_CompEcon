...
label variable trtcc "Total time spent during diary day providing secondary childcare for household and own nonhousehold children < 13 (in minutes)";
...
label variable trtcctot "Total time spent during diary day providing secondary childcare for all children < 13 (in minutes)";
label variable trtchild "Total time respondent spent with household or nonhousehold children < 18 (in minutes)";
label variable trtcoc "Total time spent during diary day providing secondary childcare for nonown, nonhousehold children < 13 (in minutes)";
...
label variable trtnohh "Total time spent during diary day providing secondary childcare for nonown household children < 13 (in minutes)";
label variable trto "Total time spent during diary day providing secondary childcare for own children < 13 (in minutes)";
label variable trtohh "Total time spent during diary day providing secondary childcare for own household children < 13 (in minutes)";
label variable trtohhchild "Total time respondent spent with own household children < 18 (in minutes)";
label variable trtonhh "Total time spent during diary day providing secondary childcare for own nonhousehold children < 13 (in minutes)";
...
label variable trtunmpart "Total time respondent spent with unmarried partner (others may be present) (in minutes)";
...
label variable tudis "Last time we spoke to someone in this household you were reported to have a disability. Does your disability prevent you from doing any kind of work for the next six months?";
...
label variable tuelder "Not including financial assistance or help you provided as part of your paid job, since the first of [REF_MONTH], have you provided any care or assistance for an adult who needed help because of a condition related to aging?";
...
label variable tuiodp1 "Last time we spoke to someone in this household, you were reported to work for (employer's name). Do you still work for (employer's name)? (main job)";
label variable tuiodp2 "Have the usual activities and duties of your job changed since (month of CPS interview)? (main job)";
label variable tuiodp3 "Last time we spoke to someone in this household, you were reported as (occupation) and your usual duties were (activities). Is this an accurate description of your current job? (main job)";
...
save "../../Stata_Raw_Data/atusresp_raw_0314.dta";
