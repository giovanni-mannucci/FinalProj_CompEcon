...
\caption{Mapping of Occupations: CPS and CNEF-PSID } \label{tablecpscnef}
...
\multicolumn{4} {p{8.2in}} { {\footnotesize{
Note: Due to the lack of crosswalk between these two classifications we construct the mapping based on the definitions of occupations.
}}}
