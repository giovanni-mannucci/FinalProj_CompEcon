...
sort occ_563
merge m:1 occ_563 using "../table4/bratio_563all.dta"
tab _merge
 ...
 * all baseline   + agg educ + male overwork + ONET   (4)
 eststo:xi: reg lprernwa i.female*bratio_563  prtage prtage2 prtage3 prtage4 lpehrusl1 i.peeduca i.ptdtrace i.year avg_educ563 male_overwork563 social_563 abstract_563 manual_563 routine_563 fracshift563_sd [aw=tubwgt], robust cluster(occ_563)
...
label variable bratio_563  "ratio8to5" 
 ...
 esttab est1 est2 est3 est4 using ./tableA8.tex,replace label se star(* .10  **  .05 *** .001) keep ( _Ifemale_1 _IfemXbrati_1 bratio_563 )  mtitles("baseline "  "baseline+agg educ"  "baseline+agg educ+ overwrk")
_eststo clear
************************************************************************
 ...
 * single, no children baseline   + agg educ + male overwork + ONET   (4)
  eststo:xi: reg lprernwa  i.female*bratio_563  prtage prtage2 prtage3 prtage4 lpehrusl1 i.peeduca i.ptdtrace i.year avg_educ563 male_overwork563 social_563 abstract_563 manual_563 routine_563 fracshift563_sd [aw=tubwgt], robust cluster(occ_563), if pemaritl~=1 & pemaritl~=2 & prnmchld<1 
...
label variable bratio_563  "ratio8to5" 
 ...
 esttab est1 est2 est3 est4 using ./tableA8.tex,append label se star(* .10  **  .05 *** .001) keep ( _Ifemale_1 _IfemXbrati_1 bratio_563 )  mtitles("baseline "  "baseline+agg educ"  "baseline+agg educ+ overwrk")
_eststo clear
  ************************************************************************
...
* married w/ children baseline   + agg educ + male overwork + ONET   (4)
 eststo:xi: reg lprernwa  i.female*bratio_563  prtage prtage2 prtage3 prtage4 lpehrusl1 i.peeduca i.ptdtrace i.year avg_educ563 male_overwork563 social_563 abstract_563 manual_563 routine_563 fracshift563_sd [aw=tubwgt], robust cluster(occ_563), if (pemaritl==1 | pemaritl==2) & prnmchld>0 
